<?php
    ...
    class CI_Input {
        ...
        public function __construct() {
            ...
            log_message('info', 'Input Class telah di inisialisasi');
        }
        ...
        protected function _sanitize_globals() {
            ...
            log_message('debug', 'Global POST, GET dan COOKIE data telah disanitasi');
        }
        ...
        protected function _clean_input_keys($str, $fatal = TRUE) {
            if (!preg_match('/^[a-z0-9:_\/|-]+$/i', $str)) {
                if ($fatal === TRUE) {
                    ...
                    echo 'Karakter yang Tak Diperbolehkan.';
                    exit(7);
                }
            }
            if (UTF8_ENABLED === TRUE) {
