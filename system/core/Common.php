    ...
    if (!function_exists('load_class')) {
        function &load_class($class, $directory = 'libraries', $param = NULL) {
            ...
            if ($name === FALSE) {
                ...
                echo 'Tidak dapat menemukan class yang ditentukan: ' . $class . '.php';
                exit(5);
            }
            is_loaded($class);
        ...
        function &get_config(Array $replace = array()) {
            ...
            if (empty($config)) {
                ...
                if (file_exists($file_path = APPPATH . 'config/' . ENVIRONMENT . '/config.php')) {
                    ...
                    set_status_header(503);
                    echo 'File konfigurasi tidak ada.';
                    exit(3);
                }
                if (!isset($config) OR !is_array($config)) {
                    set_status_header(503);
                    echo 'File konfigurasi tidak diformat dengan benar.';
                    exit(3);
                }
            }
    ...
    if (!function_exists('set_status_header')) {
        function set_status_header($code = 200, $text = '') {
            ...
            if (empty($code) OR !is_numeric($code)) {
                show_error('Kode status harus numerik', 500);
            }
            if (empty($text)) {
                ...
                $stati = array(
                    ...
                    201 => 'Dibuat',
                    202 => 'Diterima',
                    203 => 'Informasi Non-Authorisatif',
                    204 => 'Tidak ada konten',
                    205 => 'Reset Konten',
                    206 => 'Sebagian Content',
                    300 => 'Multi Pilihan',
                    301 => 'Dipindahkan Permanen',
                    302 => 'Ditemukan',
                    303 => 'Lihat Lainnya',
                    304 => 'Tidak termodifikasi',
                    305 => 'Gunakan Proxy',
                ...
                if (isset($stati[$code])) {
                    ...
                    show_error('Tidak ada teks status yang tersedia. Silakan periksa nomor kode status atau berikan teks pesan sendiri.', 500);
                }
            }
