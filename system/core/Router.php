<?php
    ...
    class CI_Router {
        ...
        public function __construct($routing = NULL) {
            ...
            log_message('info', 'Router Class telah di inisialisasi');
        }
        ...
        protected function _set_default_controller() {
            if (empty($this->default_controller)) {
                show_error('Tidak dapat menentukan apa yang harus ditampilkan. Rute default belum ditentukan dalam file routing.');
            }
            ...
            log_message('debug', 'Tidak ada URI. Memakai Default controller.');
        }
