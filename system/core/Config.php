<?php
    ...
    class CI_Config {
        ...
        public function __construct() {
            ...
            log_message('info', 'Config Class telah di inisialisasi');
        }
        public function load($file = '', $use_sections = FALSE, $fail_gracefully = FALSE) {
            ...
            foreach ($this->_config_paths as $path) {
                foreach (array(
                    ...
                    if (!isset($config) OR !is_array($config)) {
                        ...
                        show_error($file_path . ' file tidak mengandung array konfigurasi yang valid.');
                    }
                    ...
                    $config            = NULL;
                    $loaded            = TRUE;
                    log_message('debug', 'File konfigurasi dimuat: ' . $file_path);
                }
            }
            if ($loaded === TRUE) {
                return TRUE;
            ...
            show_error('File konfigurasi ' . $file . '.php tidak ada.');
        }
