    ...
    class CI_Session_database_driver extends CI_Session_driver implements SessionHandlerInterface {
        ...
        public function __construct(&$params) {
            ...
            if (!$this->_db instanceof CI_DB_query_builder) {
                throw new Exception('Query Builder tidak diaktifkan untuk database yang dikonfigurasi. Batal.');
            } elseif ($this->_db->pconnect) {
                throw new Exception('Koneksi database terkonfigurasi bersifat persisten. Batal.');
            } elseif ($this->_db->cache_on) {
                throw new Exception('Koneksi database terkonfigurasi telah mengaktifkan cache. Batal.');
            }
            ...
            if (!isset($this->_config['save_path']) && ($this->_config['save_path'] = config_item('sess_table_name'))) {
                log_message('debug', 'Session: "sess_save_path" kosong; pakai BC fallback untuk "sess_table_name".');
            }
        }
