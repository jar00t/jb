<?php
    ...
    class CI_Session {
        ...
        public function __construct(array $params = array()) {
            if (is_cli()) {
                log_message('debug', 'Session: Inisialisasi CLI dibatalkan.');
                return;
            } elseif ((bool) ini_get('session.auto_start')) {
                log_message('error', 'Session: session.auto_start aktif di php.ini. Batal.');
                return;
                ...
                log_message('debug', 'Session: "sess_driver" kosong; memakai BC fallback untuk "sess_use_database".');
            ...
            if ($class instanceof SessionHandlerInterface) {
                ...
                log_message('error', "Session: Driver '" . $this->_driver . "' tidak mengimplementasikan SessionHandlerInterface. Batal.");
                return;
            }
        ...
        protected function _ci_load_classes($driver) {
            ...
            if (!class_exists('CI_' . $class, FALSE)) {
                ...
                if (!class_exists('CI_' . $class, FALSE) && !class_exists($class, FALSE)) {
                    throw new UnexpectedValueException("Session: Driver '" . $driver . "' tidak ada. Batal.");
                }
            }
            if (!class_exists($prefix . $class, FALSE) && file_exists($file_path = APPPATH . 'libraries/Session/drivers/' . $prefix . $class . '.php')) {
                ...
                log_message('debug', 'Session: ' . $prefix . $class . ".php ada tapi tidak ter-declare class " . $prefix . $class . '.');
            }
            return 'CI_' . $class;
        }
