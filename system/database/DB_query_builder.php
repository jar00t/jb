    ...
    abstract class CI_DB_query_builder extends CI_DB_driver {
        ...
        public function insert_batch($table, $set = NULL, $escape = NULL, $batch_size = 100) {
            if ($set === NULL) {
                ...
                if (empty($set)) {
                    return ($this->db_debug) ? $this->display_error('insert_batch() tampil tanpa data') : FALSE;
                }
        ...
        public function update_batch($table, $set = NULL, $index = NULL, $batch_size = 100) {
            ...
            if ($set === NULL) {
                ...
                if (empty($set)) {
                    return ($this->db_debug) ? $this->display_error('update_batch() tampil tanpa data') : FALSE;
                }
