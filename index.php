<?php
    ...
    switch (ENVIRONMENT) {
        ...
        case 'production':
            ...
            break;
        default:
            header('HTTP/1.1 503 Program bermasalah.', TRUE, 503);
            echo 'Pengaturan Aplikasi tidak benar.';
            exit(1);
    }
    $system_path        = 'system';
    ...
    if (!is_dir($system_path)) {
        header('HTTP/1.1 503 Program bermasalah.', TRUE, 503);
        echo 'Struktur folder <i>system</i> tidak benar. Silakan buka file berikut dan perbaiki bagian ini: ' . pathinfo(__FILE__, PATHINFO_BASENAME);
        exit(3);
    }
    ...
    if (is_dir($application_folder)) {
        ...
        header('HTTP/1.1 503 Program bermasalah.', TRUE, 503);
        echo 'Struktur folder <i>application</i> tidak benar. Silakan buka file berikut dan perbaiki bagian ini: ' . SELF;
        exit(3);
    }
    ...
    if (!isset($view_folder[0]) && is_dir(APPPATH . 'views' . DIRECTORY_SEPARATOR)) {
        ...
        header('HTTP/1.1 503 Program bermasalah.', TRUE, 503);
        echo 'Struktur folder <i>views</i> tidak benar. Silakan buka file berikut dan perbaiki bagian ini: ' . SELF;
        exit(3);
    }
